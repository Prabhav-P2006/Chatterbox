...
import 'package:chatterbox/features/chat/chat_provider.dart';
import 'package:chatterbox/features/mesh/bluetooth_mesh_service.dart';
import 'package:chatterbox/features/mesh/message_handler.dart' show MessageHandler;
...
class MockMessageStorageService extends MessageStorageService {
  final List<chatterboxMessage> _publicMessages = [];
  ...
  @override
  Future<bool> addPublicMessage(chatterboxMessage message) async {
    _publicMessages.add(message);
    return true;
  }

  @override
  List<chatterboxMessage> getPublicMessages() => _publicMessages;

  @override
  Future<bool> addPrivateMessage(String peerID, chatterboxMessage message) async {
    return true;
  }

  @override
  Future<bool> addChannelMessage(String channel, chatterboxMessage message) async {
    return true;
  }
...
void main() {
  ...
  group('ChatNotifier', () {
    ...
    test('should add multiple messages in order', () {
      final message1 = chatterboxMessage(
        id: 'id1',
        sender: 'sender1',
        content: 'content1',
      ...
      final message2 = chatterboxMessage(
        id: 'id2',
        sender: 'sender2',
        content: 'content2',
    ...
    test('should clear all messages', () {
      notifier.addMessage(chatterboxMessage(
        id: 'id1',
        sender: 'sender1',
        content: 'content1',
        timestamp: DateTime(2024, 1, 1),
