...
void main() {
  ...
  group('BluetoothMeshService Message Integration', () {
    ...
    test('should encode and decode chatterbox message', () {
      ...
      final payload = chatterboxMessage.toBinaryPayload(msg);
      expect(payload, isNotNull);

      final decoded = chatterboxMessage.fromBinaryPayload(payload!);
      expect(decoded, isNotNull);
