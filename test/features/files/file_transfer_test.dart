...
void main() {
  group('FileTransfer', () {
    test('encode and decode file packet preserves data', () {
      ...
      final decoded = chatterboxFilePacket.decode(encoded!);
    ...
    test('fragmentation and reassembly works and reports progress', () async {
      ...
      final file = chatterboxFilePacket(
        fileName: 'big.bin',
