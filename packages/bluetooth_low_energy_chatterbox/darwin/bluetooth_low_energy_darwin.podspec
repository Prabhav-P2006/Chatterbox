#
# Local bluetooth_low_energy_chatterbox override with lazy BLE initialization
# to fix macOS TCC crash on app startup.
#
Pod::Spec.new do |s|
  s.name             = 'bluetooth_low_energy_darwin'
  s.version          = '6.0.0'
  s.summary          = 'bluetooth_low_energy_chatterbox with lazy BLE initialization'
  s.description      = <<-DESC
Local override of bluetooth_low_energy_chatterbox that defers CBCentralManager
