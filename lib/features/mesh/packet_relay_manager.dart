...
///
/// Handles all relay decisions and logic for chatterbox packets.
...
/// /Users/avillagran/Desarrollo/chatterbox-android/app/src/main/java/com/chatterbox/android/mesh/PacketRelayManager.kt
class PacketRelayManager {
  ...
  bool isPacketAddressedToMe(chatterboxPacket packet) {
  ...
  bool shouldRelayPacket(chatterboxPacket packet, String fromPeerID) {
