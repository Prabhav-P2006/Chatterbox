...
///
/// Android reference:
/// /Users/avillagran/Desarrollo/chatterbox-android/app/src/main/java/com/chatterbox/android/mesh/FragmentManager.kt
class FragmentManager {
  ...
  List<chatterboxPacket> createFragments(
    ...
    try {
      ...
      final fragments = <chatterboxPacket>[];
      ...
      for (int index = 0; index < totalFragments; index++) {
        ...
        final fragmentPacket = chatterboxPacket(
  ...
  chatterboxPacket? handleFragment(chatterboxPacket packet) {
    ...
    try {
      ...
      if (fragmentMap != null && fragmentMap.length == fragmentPayload.total) {
        ...
        final originalPacket = chatterboxPacket.decode(Uint8List.fromList(reassembledData));
