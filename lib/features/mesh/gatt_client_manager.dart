...
abstract class BluetoothConnectionManagerDelegate {
  ...
  /// Called when a valid chatterboxPacket is received from a connected peripheral.
  void onPacketReceived(chatterboxPacket packet, String peerID, Peripheral device);
}
...
/// advertise the chatterbox mesh service UUID and managing connections to them.
///
...
class GattClientManager {
  ...
  void _onCharacteristicChanged(Peripheral peripheral, Uint8List value) {
    ...
    final packet = chatterboxPacket.decode(value);
  ...
  Future<bool> sendPacket(Peripheral peripheral, chatterboxPacket packet) async {
    final deviceUuid = peripheral.uuid.toString();
