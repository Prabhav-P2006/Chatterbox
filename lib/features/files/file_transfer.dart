...
import 'package:chatterbox/data/models/fragment_payload.dart';
...
class FileTransferManager implements FragmentManagerDelegate {
  ...
  /// Create a chatterboxPacket that wraps the file packet as payload with fileTransfer type.
  chatterboxPacket createFilePacket(chatterboxFilePacket file) {
  ...
  List<chatterboxPacket> fragmentPacket(chatterboxPacket packet,
  ...
  Future<chatterboxPacket?> handleIncomingFragment(
      chatterboxPacket fragmentPacket) async {
    try {
  ...
  @override
  void onPacketReassembled(chatterboxPacket packet) {
