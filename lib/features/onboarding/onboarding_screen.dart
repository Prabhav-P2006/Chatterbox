...
import 'package:chatterbox/features/onboarding/onboarding_coordinator.dart';
import 'package:chatterbox/features/onboarding/onboarding_state.dart';
...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(
                  'chatterbox needs Bluetooth for:',
                  style: TextStyle(
          ...
          if (status == BluetoothStatus.disabled) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: chatterboxColors.primaryGreen,
            ...
            Text(
              ...
              'which is required for chatterbox to work.',
              style: TextStyle(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              ...
              'chatterbox does not track your location.',
              style: TextStyle(
                color: colorScheme.onSurface.withOpacity(0.8),
                fontFamily: 'monospace',
                fontSize: 13,
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              ...
              'consider disabling battery optimization for chatterbox.',
              style: TextStyle(
                color: colorScheme.onSurface.withOpacity(0.8),
                fontFamily: 'monospace',
                fontSize: 13,
      ...
      child: Column(
        ...
        children: [
          Icon(
            Icons.security,
            size: 64,
            color: chatterboxColors.primaryGreen,
          ),
          const SizedBox(height: 24),
          Text(
  ...
  Widget _buildPermissionItem(
    ...
    return Row(
      children: [
        Icon(icon, color: chatterboxColors.primaryGreen, size: 24),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Background location allows chatterbox to maintain mesh connections '
