...
/// Permission status for the chatterbox app
enum PermissionType {
  bluetoothScan,
  bluetoothConnect,
  bluetoothAdvertise,
...
/// Centralized permission management for chatterbox app
...
class PermissionService {
  ...
  Future<AppPermissionStatus> _checkBatteryOptimizationPermission() async {
    ...
    try {
      final channel = MethodChannel('com.chatterbox.permissions/native');
