...
import 'package:chatterbox/features/debug/debug_settings_provider.dart';
import 'package:chatterbox/ui/theme/chatterbox_colors.dart';
import 'package:chatterbox/ui/widgets/about_sheet.dart';
import 'package:chatterbox/ui/widgets/chat_input.dart';
import 'package:chatterbox/ui/widgets/location_channels_sheet.dart';
import 'package:chatterbox/ui/widgets/message_bubble.dart';
import 'package:chatterbox/ui/widgets/network_sidebar_content.dart';
import 'package:chatterbox/ui/widgets/responsive_sidebar.dart';
import 'package:chatterbox/ui/widgets/status_badges.dart';

/// Main chat screen for chatterbox mesh messaging.
...
class _ChatScreenState extends ConsumerState<ChatScreen> {
        ...
        Expanded(
          child: Center(
            child: Text(
              '#$channel',
              style: TextStyle(
                color: chatterboxColors.selfMessageColor,
                fontFamily: 'monospace',
                fontSize: 16,
                fontWeight: FontWeight.bold,
              ),
  ...
  /// - Mesh channel: blue (chatterboxColors.meshBlue)
  /// - Geohash channel: green (chatterboxColors.locationGreen)
  Widget _buildPeerCounter(ChatState chatState, ColorScheme colorScheme) {
    ...
    final countColor = isGeohashMode
        ? chatterboxColors.locationGreen
        : chatterboxColors.meshBlue;
  ...
  void _showMessageOptions(chatterboxMessage message) {
