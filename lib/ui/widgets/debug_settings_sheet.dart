...
class DebugSettingsSheet extends ConsumerWidget {
                          ...
                          children: [
                            ...
                            _buildInfoRow(
                              ...
                              valueColor: meshService.isActive
                                  ? chatterboxColors.rssiExcellent
                                  : chatterboxColors.rssiPoor,
                            ),
                            _buildInfoRow(
                              context,
                              'Connected Peers',
  ...
  Color _getRssiColor(int rssi) {
    if (rssi >= -50) return chatterboxColors.rssiExcellent;
    if (rssi >= -70) return chatterboxColors.rssiGood;
    if (rssi >= -85) return chatterboxColors.rssiFair;
    return chatterboxColors.rssiPoor;
  }
