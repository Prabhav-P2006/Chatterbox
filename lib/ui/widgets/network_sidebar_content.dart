    ...
    return Column(
      ...
      children: [
              ...
              if (activePeerCount > 0)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: chatterboxColors.meshBlue.withOpacity(0.15),
        ...
        _buildChannelTile(
          ...
          iconColor: chatterboxColors.meshBlue,
        ...
        if (currentGeohash != null)
          _buildChannelTile(
            ...
            iconColor: chatterboxColors.locationGreen,
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: isSelected
            ? Icon(
                Icons.check_circle,
                color: chatterboxColors.iosGreenDark,
                size: 20,
              )
            : null,
        onTap: onTap,
