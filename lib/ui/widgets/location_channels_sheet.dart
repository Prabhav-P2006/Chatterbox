...
import 'package:chatterbox/features/geohash/geohash_utils.dart';
import 'package:chatterbox/features/geohash/location_channel_manager.dart';
...
class _LocationChannelsSheetState extends ConsumerState<LocationChannelsSheet>
    ...
    return ListView(
      ...
      children: [
        ...
        _buildChannelOption(
          ...
          color: chatterboxColors.meshBlue,
          ...
          ...locationState.availableChannels.map((channel) {
            ...
            return Padding(
              ...
              child: _buildChannelOption(
                ...
                color: chatterboxColors.locationGreen,
  ...
  Widget _buildLocationStatus(
    ...
    final statusColor = isEnabled ? chatterboxColors.locationGreen : Colors.orange;
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: chatterboxColors.locationGreen,
              ...
              FlutterMap(
                ...
                children: [
                  TileLayer(
                    ...
                    userAgentPackageName: 'com.chatterbox.app',
                  ),
