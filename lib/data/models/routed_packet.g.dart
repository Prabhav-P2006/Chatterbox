...
_$RoutedPacketImpl _$$RoutedPacketImplFromJson(Map<String, dynamic> json) =>
    _$RoutedPacketImpl(
      packet: chatterboxPacket.fromJson(json['packet'] as Map<String, dynamic>),
...
_$chatterboxPacketImpl _$$chatterboxPacketImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$chatterboxPacketImplToJson(_$chatterboxPacketImpl instance) =>
    <String, dynamic>{
