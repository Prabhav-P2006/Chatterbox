...
_$chatterboxMessageImpl _$$chatterboxMessageImplFromJson(Map<String, dynamic> json) =>
    _$chatterboxMessageImpl(
      id: json['id'] as String? ?? '',
      sender: json['sender'] as String,
      content: json['content'] as String? ?? '',
      type: $enumDecodeNullable(_$chatterboxMessageTypeEnumMap, json['type']) ??
          chatterboxMessageType.Message,
...
Map<String, dynamic> _$$chatterboxMessageImplToJson(
        _$chatterboxMessageImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'sender': instance.sender,
      'content': instance.content,
      'type': _$chatterboxMessageTypeEnumMap[instance.type]!,
...
const _$chatterboxMessageTypeEnumMap = {
  chatterboxMessageType.Message: 'Message',
  chatterboxMessageType.Audio: 'Audio',
  chatterboxMessageType.Image: 'Image',
  chatterboxMessageType.File: 'File',
};
