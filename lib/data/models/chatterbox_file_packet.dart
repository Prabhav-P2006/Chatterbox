...
part 'chatterbox_file_packet.freezed.dart';
part 'chatterbox_file_packet.g.dart';

@freezed
class chatterboxFilePacket with _$chatterboxFilePacket {
  const factory chatterboxFilePacket({
    required String fileName,
    required int fileSize,
    required String mimeType,
    @Uint8ListBase64Converter() Uint8List? content,
  }) = _chatterboxFilePacket;

  factory chatterboxFilePacket.fromJson(Map<String, dynamic> json) =>
      _$chatterboxFilePacketFromJson(json);

  const chatterboxFilePacket._();
  ...
  static chatterboxFilePacket? decode(Uint8List data) {
    try {
      int off = 0;
      String? name;
      int? size;
