...
import 'package:chatterbox/protocol/message_padding.dart';
...
class PacketCodec {
  ...
  /// This matches Android's chatterboxPacket.toBinaryDataForSigning() behavior.
  ...
  static Uint8List? encodeForSigning(
    ...
    final signingPacket = chatterboxPacket(
  ...
  static chatterboxPacket? _decodeCore(Uint8List data) {
    try {
      ...
      debugPrint('[PacketCodec._decodeCore] SUCCESS - returning chatterboxPacket');
